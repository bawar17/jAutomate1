...
public class WaitXpath
{
	...
	public Boolean executeCommand(String[] commandParameters, Properties scriptParameters)
	{
		...
		{
			scriptParameters.put("Error", "Missing parameter in command. Usage: WaitXpath Xpath");
			return false;
		}
	...
	{
		String text = JOptionPane.showInputDialog(null, "Enter xpath");
		if (text != null)
		{
			return "WaitXpath \"" + text + "\"";
		}
		else
		{
			return null;
	...
	{
		return "Wait for a widget identified by an XPath";
	}
